...
MIDDLEWARE = [
    ...
    "azura.mvc.discord.middleware.BotInjectorMiddleware"
]

SESSION_ENGINE  = "django.contrib.sessions.backends.file"
SESSION_FILE_PATH = conf.temp

ROOT_URLCONF = "azura.mvc.core.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [os.path.join(conf.root_dir, "azura/mvc/core/templates")],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "azura.mvc.core.wsgi.application"
